        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
          ...
          <main class="container py-4">
                ...
                <div class="row">
                    ...
                    <a href="{{route('discussions.create')}}" style="width:100%; color:white" class="btn btn-info ny">
                    ...
                    <a href="{{route('login')}}" style="width:100%; color:white" class="btn btn-info ny">
                        ...
                        <div class="card-body">
                             <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                 ...
                                 <a href="{{route('discussions.index')}}?channel={{$channel->slug}}" class="link">
                                   {{$channel->name}}
                                 </a>
